                ...
                <div className="relative flex flex-col md:flex-row justify-between items-start mb-6">
                    <div>
                        <h3 className="relative text-3xl font-black text-white italic tracking-tight uppercase leading-tight">
                            ...
                            <CircleQuestionMark
                                size={24}
                                className="hide-in-export print:hidden absolute top-2 right-2 lg:static lg:inline-block lg:ml-2 lg:align-baseline text-orange-400 cursor-pointer hover:text-orange-500"
                                onMouseEnter={(e) => {
                                    e.stopPropagation();
                                    e.preventDefault();
                                }}

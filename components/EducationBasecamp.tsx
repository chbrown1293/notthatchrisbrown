...
export const EducationBasecamp = () => (
    <div className="bg-white/5 border border-white/10 p-8 rounded-[2.5rem] backdrop-blur-md">
        <h3 className="text-[0.625rem] font-black uppercase tracking-widest text-lime-500 mb-6 flex items-center gap-2">
        ...
        <div className="relative pl-4 border-l-2 border-slate-800">
            ...
            <span className="text-[0.625rem] font-mono text-slate-500 uppercase tracking-widest">

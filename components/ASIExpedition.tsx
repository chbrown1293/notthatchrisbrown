...
export const ASIExpedition = () => {
    ...
    return (
        <div className="relative pl-12 group">
            {modalVisible && (
                <Modal
                    title="About Advanced Symbolics Inc."
                    colorScheme="blue"
                ...
                >
                    <p className="text-sm text-gray-300 mb-6">
                        Advanced Symbolics Inc. (ASI) is a market research
                        technology company that provides data analysis tools to
                        help businesses make informed decisions. ASI specializes
                        in gathering consumer insights through various
                        methodologies, such as building representative samples
                        of online social media users.
                    </p>
                    <p className="text-sm text-gray-300">
                        ASI started out as a research consultancy in 2015, and
                        when I joined in 2017 we were primarily focused on
                        custom research projects for a variety of clients. Over
                        time, we developed our own SaaS platform to streamline
                        data collection, annotation, and analysis. This platform
                        has since become the core of ASI's offerings, allowing
                        clients to self-serve many public opinion research
                        needs.
                    </p>
                    <div className="mt-10">
                        <p className="text-sm text-gray-300">
                            ...
                            <span className="-ml-4">
                                is ASI's flagship product, providing users with
                                powerful tools to explore and visualize market
                                research leading to actionable insights.
                                Developed with Next.js, askpolly is a modern
                                mobile-friendly web application providing an
                                intuitive interface for querying our samples and
                                dashboards built with D3.js for visualization..
                            </span>
                        </p>
                    </div>
                </Modal>
